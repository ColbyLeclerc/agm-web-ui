...
//  Somehow pass auth id here, then iterate over each to generate graph for each plant

  // const lineChartBox = document.getElementById('line-chart');
  // const lineChartBox2 = document.getElementById('line-chart-2');
